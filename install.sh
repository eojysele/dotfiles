    ...
    do
        case "$config" in 
            alacritty)
                ...
                ln -s $current_folder/alacritty/toml/alacritty.toml $alacritty_config_folder/alacritty.toml
                ln -s $current_folder/alacritty/toml/colors.toml $alacritty_config_folder/colors.toml

                if [[ $mac == "true" ]]; then
                    ln -s $current_folder/alacritty/toml/macos.toml $alacritty_config_folder/os.toml
                else 
                    ln -s $current_folder/alacritty/toml/linux.toml $alacritty_config_folder/os.toml
                fi
