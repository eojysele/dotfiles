...
local function setup_other_os_keys()
	local keys = {
		...
		{ key = "T",          mods = "CTRL|SHIFT", action = action.SendKey { key = "t", mods = "CTRL" } },
		{ key = "w",          mods = "CTRL",       action = action.CloseCurrentTab { confirm = true } },
		{ key = "W",          mods = "CTRL|SHIFT", action = action.SendKey { key = "w", mods = "CTRL" } },
		...
		{ key = "F",          mods = "CTRL|SHIFT", action = action.SendKey { key = "f", mods = "CTRL" } },
